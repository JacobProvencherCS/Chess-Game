...
class Board:
    ...
    def __str__(self):
        ...
        for piece in chain(self.player1.pieces, self.player2.pieces):
            ...
            board[8-y][x-1] = piece.piece_type
...
class Piece:
    ...
    def __init__(self, color, coord, piece_type):
        self.color = color
...
class Player:
    ...
    def __init__(self, color):
        self.color = color
        self.pieces = [Piece(color, coord, piece_type) for coord, piece_type in
                      zip(product(range(1, 9), range(1, 3)), 'TPCPFPQPKPFPCPTP')]

    def move(self, pos1, pos2):
        for piece in self.pieces:
            current_position = (piece.pos.x, piece.pos.y)
            if current_position == pos1 and self.is_legal_move(pos1, pos2):
                piece.pos.x, piece.pos.y = pos2
                break

    def eat(self, opponent, pos1, pos2):
        self.move(pos1, pos2)
        opponent.remove_piece(pos2)

    def is_legal_move(self, pos1, pos2):
        return True
...
class Game:
    ...
    def __init__(self, color='white'):
        ...
        self.player2 = Robot(self.switch_color[color])
